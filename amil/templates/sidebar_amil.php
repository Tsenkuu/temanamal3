...
<nav class="app-sidebar">
    ...
    <div class="sidebar-menu p-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'tugas_saya.php') ? 'active' : ''; ?>" href="tugas_saya">
                    <i class="bi bi-card-checklist me-2"></i> Tugas Saya
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo in_array($current_page, ['riwayat_pengambilan.php', 'edit_pengambilan.php']) ? 'active' : ''; ?>" href="riwayat_pengambilan">
                    <i class="bi bi-clock-history me-2"></i> Riwayat
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'peta_kotak_infak.php') ? 'active' : ''; ?>" href="peta_kotak_infak">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo in_array($current_page, ['kelola_kotak_infaq.php', 'tambah_kotak_infak.php', 'edit_kotak_infak.php']) ? 'active' : ''; ?>" href="kelola_kotak_infaq">
                    <i class="bi bi-box-seam-fill me-2"></i> Kotak Infak
                </a>
            </li>
             <li class="nav-item">
                <a class="nav-link <?php echo in_array($current_page, ['kelola_berita.php', 'tambah_berita.php', 'edit_berita.php']) ? 'active' : ''; ?>" href="kelola_berita">
            ...
            <li class="nav-item-header text-muted small text-uppercase my-2 pt-2">Akun</li>
             <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'edit_profil.php') ? 'active' : ''; ?>" href="edit_profil">
