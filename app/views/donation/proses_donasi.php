...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        if (defined('ADMIN_WA_NUMBER') && !empty(ADMIN_WA_NUMBER)) {
            $pesan_admin = "🔔 *Donasi Baru Masuk*\n\n" .
                           "*Invoice:* {$invoice_id}\n" .
                           "*Nama:* {$nama_lengkap_donatur}\n" .
                           "*Program:* {$nama_program}\n" .
                           "*Nominal:* Rp " . number_format($total_transfer, 0, ',', '.') . "\n" .
                           "*Metode:* {$metode['nama_metode']}\n\n" .
                           "Status: Menunggu Pembayaran dari Donatur.";
