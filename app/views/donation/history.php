...
if (!$donasi) {
    header("Location: " . BASE_URL . "/error?code=404");
    exit();
}
...
<main class="container mx-auto my-12 px-4 md:px-6">
    <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-6 md:p-8">
            ...
            <!-- Form Upload Bukti -->
            <form action="<?php echo BASE_URL; ?>/upload_bukti" method="POST" enctype="multipart/form-data" class="mt-6">
                <?php echo csrf_field(); ?>
            ...
            <?php elseif ($donasi['status'] == 'Selesai'): ?>
                <div class="text-center py-8">
                    ...
                    <a href="<?php echo BASE_URL; ?>/program" class="inline-block mt-4 text-primary-orange font-semibold hover:underline">Donasi Lagi</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
