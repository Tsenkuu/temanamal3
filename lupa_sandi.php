    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white p-8 md:p-10 rounded-[24px] shadow-card border border-gray-100">
            ...
            <div class="bg-green-50 border border-green-200 p-6 mb-6 rounded-2xl text-center shadow-sm">
                ...
                <a href="reset_sandi.php" class="block w-full bg-primary-orange text-white font-bold py-3.5 rounded-xl hover:bg-orange-600 active:scale-[0.98] transition-all shadow-lg shadow-orange-200">
            ...
            <?php if ($show_form): ?>
            <form action="lupa_sandi.php" method="POST" class="space-y-6" @submit="isLoading = true">
