...
<nav class="fixed bottom-0 left-0 right-0 bg-white z-50 md:hidden shadow-[0_-8px_30px_rgba(0,0,0,0.08)] rounded-t-[32px]">
    ...
    <div class="flex justify-around items-end px-2 pt-3 pb-safe relative">
        ...
        <a href="<?php echo BASE_URL; ?>/" class="flex flex-col items-center justify-center w-[18%] pb-2 group <?php echo ($current_path == '/' || $current_path == '/index.php' || $current_path == '/beranda') ? 'text-primary-orange' : 'text-slate-400'; ?>">
            <div class="relative w-12 h-12 flex items-center justify-center rounded-full transition-all duration-300 <?php echo ($current_path == '/' || $current_path == '/index.php' || $current_path == '/beranda') ? 'bg-orange-50' : 'bg-transparent'; ?>">
                <i class="bi bi-house-door<?php echo ($current_path == '/' || $current_path == '/index.php' || $current_path == '/beranda') ? '-fill' : ''; ?> text-[24px]"></i>
            </div>
            <span class="text-[11px] font-medium mt-0.5 tracking-tight">Beranda</span>
        </a>
        
        <a href="<?php echo BASE_URL; ?>/program" class="flex flex-col items-center justify-center w-[18%] pb-2 group <?php echo (strpos($current_path, '/program') === 0) ? 'text-primary-orange' : 'text-slate-400'; ?>">
            <div class="relative w-12 h-12 flex items-center justify-center rounded-full transition-all duration-300 <?php echo (strpos($current_path, '/program') === 0) ? 'bg-orange-50' : 'bg-transparent'; ?>">
                <i class="bi bi-grid<?php echo (strpos($current_path, '/program') === 0) ? '-fill' : ''; ?> text-[24px]"></i>
            </div>
        ...
        <a href="<?php echo BASE_URL; ?>/berita" class="flex flex-col items-center justify-center w-[18%] pb-2 group <?php echo (strpos($current_path, '/berita') === 0) ? 'text-primary-orange' : 'text-slate-400'; ?>">
            <div class="relative w-12 h-12 flex items-center justify-center rounded-full transition-all duration-300 <?php echo (strpos($current_path, '/berita') === 0) ? 'bg-orange-50' : 'bg-transparent'; ?>">
                <i class="bi bi-newspaper text-[24px]"></i>
            </div>
            <span class="text-[11px] font-medium mt-0.5 tracking-tight">Berita</span>
        </a>
        
        <a href="<?php echo BASE_URL; ?>/login" class="flex flex-col items-center justify-center w-[18%] pb-2 group <?php echo (strpos($current_path, '/login') === 0 || strpos($current_path, '/user') === 0) ? 'text-primary-orange' : 'text-slate-400'; ?>">
            <div class="relative w-12 h-12 flex items-center justify-center rounded-full transition-all duration-300 <?php echo (strpos($current_path, '/login') === 0 || strpos($current_path, '/user') === 0) ? 'bg-orange-50' : 'bg-transparent'; ?>">
                <i class="bi bi-person<?php echo (strpos($current_path, '/login') === 0 || strpos($current_path, '/user') === 0) ? '-fill' : ''; ?> text-[24px]"></i>
            </div>
